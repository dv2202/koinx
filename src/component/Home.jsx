...
const Home = () => {
  ...
  return (
    <div className='bg-[#e2e2e2] w-full absolute overflow-x-hidden'>
      ...
      <div className='max-w-[1328px] mx-auto flex md:flex-row gap-4 '>
        {/* Left Side */}
      ...
      <div className="md:w-full md:mt-[40px] w-[384px] h-fit overflow-hidden md:rounded-none  md:block hidden ">
        <Footer />
      </div>
    </div>
  );
